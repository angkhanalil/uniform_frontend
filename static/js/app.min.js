!function (i) {
    ...
    t.prototype.initMenu = function () {
        ...
        i(".side-nav").length && (t = i(".side-nav li .collapse"),
        ...
        i(".side-nav a").each(function () {
            ...
            this.href == o && (i(this).addClass("active"),
...
function (a) {
    ...
    t.prototype._selectOptionsFromConfig = function () {
        ...
        if (t) {
            switch (a(".end-bar input[type=checkbox]").prop("checked", !1),
            t.sideBarTheme) {
                case "default":
            ...
            t.isDarkModeEnabled && (a("#dark-mode-check").prop("checked", !0),
            "vertical" === t.layout && a("input[type=checkbox][name=theme]").prop("disabled", !1))
        }
    }
    ,
    ...
    t.prototype.init = function () {
        ...
        a(document).on("click", "body", function (t) {
            0 < a(t.target).closest(".end-bar-toggle, .end-bar").length || 0 < a(t.target).closest(".leftside-menu, .side-nav").length || a(t.target).hasClass("button-menu-mobile") || 0 < a(t.target).closest(".button-menu-mobile").length || (a("body").removeClass("end-bar-enabled"),
...
function (a) {
    ...
    t.prototype._getStoredConfig = function () {
        var t = this.body.data("layoutConfig")
          , e = n;
        return t && (e.sideBarTheme = t.leftSideBarTheme,
    ...
    t.prototype._applyConfig = function () {
        var t = this;
        switch (this._config = this._getStoredConfig(),
        a.LeftSidebar.init(),
    ...
    t.prototype.activateDarkMode = function () {
        ...
        "detached" === !this.body.attr("data-layout") ? (a.LeftSidebar.activateDarkTheme(),
        this._saveConfig({
            isDarkModeEnabled: !0,
            sideBarTheme: i
        })) : this._saveConfig({
...
function (a) {
    ...
    t.prototype.initFormValidation = function () {
        a(".needs-validation").on("submit", function (t) {
            ...
            !1 !== a(this)[0].checkValidity() || (t.preventDefault(),
            t.stopPropagation(),
            !1)
        })
    }
    ...
    t.prototype.initSyntaxHighlight = function () {
        a(document).ready(function (t) {
            document.querySelectorAll("pre span.escape").forEach(function (t, e) {
                for (var a = 1 / 0, o = (t.classList.contains("escape"),
                t.innerText).replace(/^\n/, "").trimRight().split("\n"), i = 0; i < o.length; i++)
...
function (a) {
    ...
    t.prototype.init = function () {
        ...
        a.RightBar.init();
        var t = this.$body.data("layoutConfig");
        window.sessionStorage && t && t.hasOwnProperty("showRightSidebarOnStart") && t.showRightSidebarOnStart && (sessionStorage.getItem("_HYPER_VISITED_") || (a.RightBar.toggleRightSideBar(),
        ...
        //document.getElementById("dark-style").href.includes("rtl.min.css") && (document.getElementsByTagName("html")[0].dir = "rtl")
    }
    ,
    a.App = new t,
    a.App.Constructor = t
